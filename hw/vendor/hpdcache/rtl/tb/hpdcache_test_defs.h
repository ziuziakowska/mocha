...
#ifndef CONF_HPDCACHE_WORD_USER_WIDTH
#define HPDCACHE_WORD_USER_WIDTH         1
#else
#define HPDCACHE_WORD_USER_WIDTH         (CONF_HPDCACHE_WORD_WIDTH)
#endif
