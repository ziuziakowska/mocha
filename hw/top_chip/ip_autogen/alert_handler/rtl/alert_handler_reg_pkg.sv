...
package alert_handler_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    alert_handler_reg2hw_intr_state_reg_t intr_state; // [841:838]
    alert_handler_reg2hw_intr_enable_reg_t intr_enable; // [837:834]
    alert_handler_reg2hw_intr_test_reg_t intr_test; // [833:826]
    alert_handler_reg2hw_ping_timeout_cyc_shadowed_reg_t ping_timeout_cyc_shadowed; // [825:810]
    alert_handler_reg2hw_ping_timer_en_shadowed_reg_t ping_timer_en_shadowed; // [809:809]
    alert_handler_reg2hw_alert_regwen_mreg_t [0:0] alert_regwen; // [808:808]
    alert_handler_reg2hw_alert_en_shadowed_mreg_t [0:0] alert_en_shadowed; // [807:807]
    alert_handler_reg2hw_alert_class_shadowed_mreg_t [0:0] alert_class_shadowed; // [806:805]
    alert_handler_reg2hw_alert_cause_mreg_t [0:0] alert_cause; // [804:804]
  ...
  typedef struct packed {
    ...
    alert_handler_hw2reg_alert_cause_mreg_t [0:0] alert_cause; // [227:226]
  ...
  parameter logic [BlockAw-1:0] ALERT_HANDLER_ALERT_REGWEN_OFFSET = 9'h 18;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_ALERT_EN_SHADOWED_OFFSET = 9'h 1c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_ALERT_CLASS_SHADOWED_OFFSET = 9'h 20;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_ALERT_CAUSE_OFFSET = 9'h 24;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_0_OFFSET = 9'h 28;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_1_OFFSET = 9'h 2c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_2_OFFSET = 9'h 30;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_3_OFFSET = 9'h 34;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_4_OFFSET = 9'h 38;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_5_OFFSET = 9'h 3c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_REGWEN_6_OFFSET = 9'h 40;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_0_OFFSET = 9'h 44;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_1_OFFSET = 9'h 48;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_2_OFFSET = 9'h 4c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_3_OFFSET = 9'h 50;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_4_OFFSET = 9'h 54;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_5_OFFSET = 9'h 58;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_6_OFFSET = 9'h 5c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_0_OFFSET = 9'h 60;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_1_OFFSET = 9'h 64;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_2_OFFSET = 9'h 68;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_3_OFFSET = 9'h 6c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_4_OFFSET = 9'h 70;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_5_OFFSET = 9'h 74;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_6_OFFSET = 9'h 78;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_0_OFFSET = 9'h 7c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_1_OFFSET = 9'h 80;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_2_OFFSET = 9'h 84;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_3_OFFSET = 9'h 88;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_4_OFFSET = 9'h 8c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_5_OFFSET = 9'h 90;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_LOC_ALERT_CAUSE_6_OFFSET = 9'h 94;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_REGWEN_OFFSET = 9'h 98;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_CTRL_SHADOWED_OFFSET = 9'h 9c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_CLR_REGWEN_OFFSET = 9'h a0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_CLR_SHADOWED_OFFSET = 9'h a4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_ACCUM_CNT_OFFSET = 9'h a8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_ACCUM_THRESH_SHADOWED_OFFSET = 9'h ac;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_TIMEOUT_CYC_SHADOWED_OFFSET = 9'h b0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_CRASHDUMP_TRIGGER_SHADOWED_OFFSET = 9'h b4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED_OFFSET = 9'h b8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED_OFFSET = 9'h bc;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED_OFFSET = 9'h c0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED_OFFSET = 9'h c4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_ESC_CNT_OFFSET = 9'h c8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSA_STATE_OFFSET = 9'h cc;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_REGWEN_OFFSET = 9'h d0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_CTRL_SHADOWED_OFFSET = 9'h d4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_CLR_REGWEN_OFFSET = 9'h d8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_CLR_SHADOWED_OFFSET = 9'h dc;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_ACCUM_CNT_OFFSET = 9'h e0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED_OFFSET = 9'h e4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED_OFFSET = 9'h e8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_CRASHDUMP_TRIGGER_SHADOWED_OFFSET = 9'h ec;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED_OFFSET = 9'h f0;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED_OFFSET = 9'h f4;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED_OFFSET = 9'h f8;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED_OFFSET = 9'h fc;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_ESC_CNT_OFFSET = 9'h 100;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSB_STATE_OFFSET = 9'h 104;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_REGWEN_OFFSET = 9'h 108;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_CTRL_SHADOWED_OFFSET = 9'h 10c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_CLR_REGWEN_OFFSET = 9'h 110;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_CLR_SHADOWED_OFFSET = 9'h 114;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_ACCUM_CNT_OFFSET = 9'h 118;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED_OFFSET = 9'h 11c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED_OFFSET = 9'h 120;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_CRASHDUMP_TRIGGER_SHADOWED_OFFSET = 9'h 124;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_PHASE0_CYC_SHADOWED_OFFSET = 9'h 128;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_PHASE1_CYC_SHADOWED_OFFSET = 9'h 12c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_PHASE2_CYC_SHADOWED_OFFSET = 9'h 130;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_PHASE3_CYC_SHADOWED_OFFSET = 9'h 134;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_ESC_CNT_OFFSET = 9'h 138;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSC_STATE_OFFSET = 9'h 13c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_REGWEN_OFFSET = 9'h 140;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_CTRL_SHADOWED_OFFSET = 9'h 144;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_CLR_REGWEN_OFFSET = 9'h 148;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_CLR_SHADOWED_OFFSET = 9'h 14c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_ACCUM_CNT_OFFSET = 9'h 150;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_ACCUM_THRESH_SHADOWED_OFFSET = 9'h 154;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_TIMEOUT_CYC_SHADOWED_OFFSET = 9'h 158;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_CRASHDUMP_TRIGGER_SHADOWED_OFFSET = 9'h 15c;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_PHASE0_CYC_SHADOWED_OFFSET = 9'h 160;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_PHASE1_CYC_SHADOWED_OFFSET = 9'h 164;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_PHASE2_CYC_SHADOWED_OFFSET = 9'h 168;
  parameter logic [BlockAw-1:0] ALERT_HANDLER_CLASSD_PHASE3_CYC_SHADOWED_OFFSET = 9'h 16c;
  ...
  parameter logic [3:0] ALERT_HANDLER_PERMIT [94] = '{
    ...
    4'b 0001, // index[ 6] ALERT_HANDLER_ALERT_REGWEN
    4'b 0001, // index[ 7] ALERT_HANDLER_ALERT_EN_SHADOWED
    4'b 0001, // index[ 8] ALERT_HANDLER_ALERT_CLASS_SHADOWED
    4'b 0001, // index[ 9] ALERT_HANDLER_ALERT_CAUSE
    4'b 0001, // index[10] ALERT_HANDLER_LOC_ALERT_REGWEN_0
    4'b 0001, // index[11] ALERT_HANDLER_LOC_ALERT_REGWEN_1
    4'b 0001, // index[12] ALERT_HANDLER_LOC_ALERT_REGWEN_2
    4'b 0001, // index[13] ALERT_HANDLER_LOC_ALERT_REGWEN_3
    4'b 0001, // index[14] ALERT_HANDLER_LOC_ALERT_REGWEN_4
    4'b 0001, // index[15] ALERT_HANDLER_LOC_ALERT_REGWEN_5
    4'b 0001, // index[16] ALERT_HANDLER_LOC_ALERT_REGWEN_6
    4'b 0001, // index[17] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_0
    4'b 0001, // index[18] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_1
    4'b 0001, // index[19] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_2
    4'b 0001, // index[20] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_3
    4'b 0001, // index[21] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_4
    4'b 0001, // index[22] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_5
    4'b 0001, // index[23] ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_6
    4'b 0001, // index[24] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_0
    4'b 0001, // index[25] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_1
    4'b 0001, // index[26] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_2
    4'b 0001, // index[27] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_3
    4'b 0001, // index[28] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_4
    4'b 0001, // index[29] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_5
    4'b 0001, // index[30] ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_6
    4'b 0001, // index[31] ALERT_HANDLER_LOC_ALERT_CAUSE_0
    4'b 0001, // index[32] ALERT_HANDLER_LOC_ALERT_CAUSE_1
    4'b 0001, // index[33] ALERT_HANDLER_LOC_ALERT_CAUSE_2
    4'b 0001, // index[34] ALERT_HANDLER_LOC_ALERT_CAUSE_3
    4'b 0001, // index[35] ALERT_HANDLER_LOC_ALERT_CAUSE_4
    4'b 0001, // index[36] ALERT_HANDLER_LOC_ALERT_CAUSE_5
    4'b 0001, // index[37] ALERT_HANDLER_LOC_ALERT_CAUSE_6
    4'b 0001, // index[38] ALERT_HANDLER_CLASSA_REGWEN
    4'b 0011, // index[39] ALERT_HANDLER_CLASSA_CTRL_SHADOWED
    4'b 0001, // index[40] ALERT_HANDLER_CLASSA_CLR_REGWEN
    4'b 0001, // index[41] ALERT_HANDLER_CLASSA_CLR_SHADOWED
    4'b 0011, // index[42] ALERT_HANDLER_CLASSA_ACCUM_CNT
    4'b 0011, // index[43] ALERT_HANDLER_CLASSA_ACCUM_THRESH_SHADOWED
    4'b 1111, // index[44] ALERT_HANDLER_CLASSA_TIMEOUT_CYC_SHADOWED
    4'b 0001, // index[45] ALERT_HANDLER_CLASSA_CRASHDUMP_TRIGGER_SHADOWED
    4'b 1111, // index[46] ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED
    4'b 1111, // index[47] ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED
    4'b 1111, // index[48] ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED
    4'b 1111, // index[49] ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED
    4'b 1111, // index[50] ALERT_HANDLER_CLASSA_ESC_CNT
    4'b 0001, // index[51] ALERT_HANDLER_CLASSA_STATE
    4'b 0001, // index[52] ALERT_HANDLER_CLASSB_REGWEN
    4'b 0011, // index[53] ALERT_HANDLER_CLASSB_CTRL_SHADOWED
    4'b 0001, // index[54] ALERT_HANDLER_CLASSB_CLR_REGWEN
    4'b 0001, // index[55] ALERT_HANDLER_CLASSB_CLR_SHADOWED
    4'b 0011, // index[56] ALERT_HANDLER_CLASSB_ACCUM_CNT
    4'b 0011, // index[57] ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED
    4'b 1111, // index[58] ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED
    4'b 0001, // index[59] ALERT_HANDLER_CLASSB_CRASHDUMP_TRIGGER_SHADOWED
    4'b 1111, // index[60] ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED
    4'b 1111, // index[61] ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED
    4'b 1111, // index[62] ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED
    4'b 1111, // index[63] ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED
    4'b 1111, // index[64] ALERT_HANDLER_CLASSB_ESC_CNT
    4'b 0001, // index[65] ALERT_HANDLER_CLASSB_STATE
    4'b 0001, // index[66] ALERT_HANDLER_CLASSC_REGWEN
    4'b 0011, // index[67] ALERT_HANDLER_CLASSC_CTRL_SHADOWED
    4'b 0001, // index[68] ALERT_HANDLER_CLASSC_CLR_REGWEN
    4'b 0001, // index[69] ALERT_HANDLER_CLASSC_CLR_SHADOWED
    4'b 0011, // index[70] ALERT_HANDLER_CLASSC_ACCUM_CNT
    4'b 0011, // index[71] ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED
    4'b 1111, // index[72] ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED
    4'b 0001, // index[73] ALERT_HANDLER_CLASSC_CRASHDUMP_TRIGGER_SHADOWED
    4'b 1111, // index[74] ALERT_HANDLER_CLASSC_PHASE0_CYC_SHADOWED
    4'b 1111, // index[75] ALERT_HANDLER_CLASSC_PHASE1_CYC_SHADOWED
    4'b 1111, // index[76] ALERT_HANDLER_CLASSC_PHASE2_CYC_SHADOWED
    4'b 1111, // index[77] ALERT_HANDLER_CLASSC_PHASE3_CYC_SHADOWED
    4'b 1111, // index[78] ALERT_HANDLER_CLASSC_ESC_CNT
    4'b 0001, // index[79] ALERT_HANDLER_CLASSC_STATE
    4'b 0001, // index[80] ALERT_HANDLER_CLASSD_REGWEN
    4'b 0011, // index[81] ALERT_HANDLER_CLASSD_CTRL_SHADOWED
    4'b 0001, // index[82] ALERT_HANDLER_CLASSD_CLR_REGWEN
    4'b 0001, // index[83] ALERT_HANDLER_CLASSD_CLR_SHADOWED
    4'b 0011, // index[84] ALERT_HANDLER_CLASSD_ACCUM_CNT
    4'b 0011, // index[85] ALERT_HANDLER_CLASSD_ACCUM_THRESH_SHADOWED
    4'b 1111, // index[86] ALERT_HANDLER_CLASSD_TIMEOUT_CYC_SHADOWED
    4'b 0001, // index[87] ALERT_HANDLER_CLASSD_CRASHDUMP_TRIGGER_SHADOWED
    4'b 1111, // index[88] ALERT_HANDLER_CLASSD_PHASE0_CYC_SHADOWED
    4'b 1111, // index[89] ALERT_HANDLER_CLASSD_PHASE1_CYC_SHADOWED
    4'b 1111, // index[90] ALERT_HANDLER_CLASSD_PHASE2_CYC_SHADOWED
    4'b 1111, // index[91] ALERT_HANDLER_CLASSD_PHASE3_CYC_SHADOWED
