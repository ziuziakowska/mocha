...
module alert_handler_reg_top (
  ...
  logic alert_en_shadowed_re;
  logic alert_en_shadowed_we;
  logic alert_en_shadowed_qs;
  logic alert_en_shadowed_wd;
  logic alert_en_shadowed_storage_err;
  logic alert_en_shadowed_update_err;
  logic alert_class_shadowed_re;
  logic alert_class_shadowed_we;
  logic [1:0] alert_class_shadowed_qs;
  logic [1:0] alert_class_shadowed_wd;
  logic alert_class_shadowed_storage_err;
  logic alert_class_shadowed_update_err;
  ...
  // R[alert_en_shadowed]: V(False)
  // Create REGWEN-gated WE signal
  logic alert_en_shadowed_gated_we;
  assign alert_en_shadowed_gated_we = alert_en_shadowed_we & alert_regwen_qs;
  prim_subreg_shadow #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    ...
    // from register interface
    .re     (alert_en_shadowed_re),
    .we     (alert_en_shadowed_gated_we),
    .wd     (alert_en_shadowed_wd),
    ...
    // to register interface (read)
    .qs     (alert_en_shadowed_qs),

    // Shadow register phase. Relevant for hwext only.
    .phase  (),

    // Shadow register error conditions
    .err_update  (alert_en_shadowed_update_err),
    .err_storage (alert_en_shadowed_storage_err)
  );


  // Subregister 0 of Multireg alert_class_shadowed
  // R[alert_class_shadowed]: V(False)
  // Create REGWEN-gated WE signal
  logic alert_class_shadowed_gated_we;
  assign alert_class_shadowed_gated_we = alert_class_shadowed_we & alert_regwen_qs;
  prim_subreg_shadow #(
    .DW      (2),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (2'h0),
    .Mubi    (1'b0)
  ) u_alert_class_shadowed (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),
    .rst_shadowed_ni (rst_shadowed_ni),

    // from register interface
    .re     (alert_class_shadowed_re),
    .we     (alert_class_shadowed_gated_we),
    .wd     (alert_class_shadowed_wd),
    ...
    // to register interface (read)
    .qs     (alert_class_shadowed_qs),

    // Shadow register phase. Relevant for hwext only.
    .phase  (),

    // Shadow register error conditions
    .err_update  (alert_class_shadowed_update_err),
    .err_storage (alert_class_shadowed_storage_err)
  );
  ...
  always_comb begin
    ...
    addr_hit[ 6] = (reg_addr == ALERT_HANDLER_ALERT_REGWEN_OFFSET);
    addr_hit[ 7] = (reg_addr == ALERT_HANDLER_ALERT_EN_SHADOWED_OFFSET);
    addr_hit[ 8] = (reg_addr == ALERT_HANDLER_ALERT_CLASS_SHADOWED_OFFSET);
    addr_hit[ 9] = (reg_addr == ALERT_HANDLER_ALERT_CAUSE_OFFSET);
    addr_hit[10] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_0_OFFSET);
    addr_hit[11] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_1_OFFSET);
    addr_hit[12] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_2_OFFSET);
    addr_hit[13] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_3_OFFSET);
    addr_hit[14] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_4_OFFSET);
    addr_hit[15] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_5_OFFSET);
    addr_hit[16] = (reg_addr == ALERT_HANDLER_LOC_ALERT_REGWEN_6_OFFSET);
    addr_hit[17] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_0_OFFSET);
    addr_hit[18] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_1_OFFSET);
    addr_hit[19] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_2_OFFSET);
    addr_hit[20] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_3_OFFSET);
    addr_hit[21] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_4_OFFSET);
    addr_hit[22] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_5_OFFSET);
    addr_hit[23] = (reg_addr == ALERT_HANDLER_LOC_ALERT_EN_SHADOWED_6_OFFSET);
    addr_hit[24] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_0_OFFSET);
    addr_hit[25] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_1_OFFSET);
    addr_hit[26] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_2_OFFSET);
    addr_hit[27] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_3_OFFSET);
    addr_hit[28] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_4_OFFSET);
    addr_hit[29] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_5_OFFSET);
    addr_hit[30] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CLASS_SHADOWED_6_OFFSET);
    addr_hit[31] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_0_OFFSET);
    addr_hit[32] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_1_OFFSET);
    addr_hit[33] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_2_OFFSET);
    addr_hit[34] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_3_OFFSET);
    addr_hit[35] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_4_OFFSET);
    addr_hit[36] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_5_OFFSET);
    addr_hit[37] = (reg_addr == ALERT_HANDLER_LOC_ALERT_CAUSE_6_OFFSET);
    addr_hit[38] = (reg_addr == ALERT_HANDLER_CLASSA_REGWEN_OFFSET);
    addr_hit[39] = (reg_addr == ALERT_HANDLER_CLASSA_CTRL_SHADOWED_OFFSET);
    addr_hit[40] = (reg_addr == ALERT_HANDLER_CLASSA_CLR_REGWEN_OFFSET);
    addr_hit[41] = (reg_addr == ALERT_HANDLER_CLASSA_CLR_SHADOWED_OFFSET);
    addr_hit[42] = (reg_addr == ALERT_HANDLER_CLASSA_ACCUM_CNT_OFFSET);
    addr_hit[43] = (reg_addr == ALERT_HANDLER_CLASSA_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[44] = (reg_addr == ALERT_HANDLER_CLASSA_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[45] = (reg_addr == ALERT_HANDLER_CLASSA_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[46] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[47] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[48] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[49] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[50] = (reg_addr == ALERT_HANDLER_CLASSA_ESC_CNT_OFFSET);
    addr_hit[51] = (reg_addr == ALERT_HANDLER_CLASSA_STATE_OFFSET);
    addr_hit[52] = (reg_addr == ALERT_HANDLER_CLASSB_REGWEN_OFFSET);
    addr_hit[53] = (reg_addr == ALERT_HANDLER_CLASSB_CTRL_SHADOWED_OFFSET);
    addr_hit[54] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_REGWEN_OFFSET);
    addr_hit[55] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_SHADOWED_OFFSET);
    addr_hit[56] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_CNT_OFFSET);
    addr_hit[57] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[58] = (reg_addr == ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[59] = (reg_addr == ALERT_HANDLER_CLASSB_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[60] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[61] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[62] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[63] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[64] = (reg_addr == ALERT_HANDLER_CLASSB_ESC_CNT_OFFSET);
    addr_hit[65] = (reg_addr == ALERT_HANDLER_CLASSB_STATE_OFFSET);
    addr_hit[66] = (reg_addr == ALERT_HANDLER_CLASSC_REGWEN_OFFSET);
    addr_hit[67] = (reg_addr == ALERT_HANDLER_CLASSC_CTRL_SHADOWED_OFFSET);
    addr_hit[68] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_REGWEN_OFFSET);
    addr_hit[69] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_SHADOWED_OFFSET);
    addr_hit[70] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_CNT_OFFSET);
    addr_hit[71] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[72] = (reg_addr == ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[73] = (reg_addr == ALERT_HANDLER_CLASSC_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[74] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[75] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[76] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[77] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[78] = (reg_addr == ALERT_HANDLER_CLASSC_ESC_CNT_OFFSET);
    addr_hit[79] = (reg_addr == ALERT_HANDLER_CLASSC_STATE_OFFSET);
    addr_hit[80] = (reg_addr == ALERT_HANDLER_CLASSD_REGWEN_OFFSET);
    addr_hit[81] = (reg_addr == ALERT_HANDLER_CLASSD_CTRL_SHADOWED_OFFSET);
    addr_hit[82] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_REGWEN_OFFSET);
    addr_hit[83] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_SHADOWED_OFFSET);
    addr_hit[84] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_CNT_OFFSET);
    addr_hit[85] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[86] = (reg_addr == ALERT_HANDLER_CLASSD_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[87] = (reg_addr == ALERT_HANDLER_CLASSD_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[88] = (reg_addr == ALERT_HANDLER_CLASSD_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[89] = (reg_addr == ALERT_HANDLER_CLASSD_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[90] = (reg_addr == ALERT_HANDLER_CLASSD_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[91] = (reg_addr == ALERT_HANDLER_CLASSD_PHASE3_CYC_SHADOWED_OFFSET);
  ...
  assign alert_regwen_we = addr_hit[6] & reg_we & !reg_error;

  assign alert_regwen_wd = reg_wdata[0];
  assign alert_en_shadowed_re = addr_hit[7] & reg_re & !reg_error;
  assign alert_en_shadowed_we = addr_hit[7] & reg_we & !reg_error;

  assign alert_en_shadowed_wd = reg_wdata[0];
  assign alert_class_shadowed_re = addr_hit[8] & reg_re & !reg_error;
  assign alert_class_shadowed_we = addr_hit[8] & reg_we & !reg_error;

  assign alert_class_shadowed_wd = reg_wdata[1:0];
  assign alert_cause_we = addr_hit[9] & reg_we & !reg_error;

  assign alert_cause_wd = reg_wdata[0];
  assign loc_alert_regwen_0_we = addr_hit[10] & reg_we & !reg_error;

  assign loc_alert_regwen_0_wd = reg_wdata[0];
  assign loc_alert_regwen_1_we = addr_hit[11] & reg_we & !reg_error;

  assign loc_alert_regwen_1_wd = reg_wdata[0];
  assign loc_alert_regwen_2_we = addr_hit[12] & reg_we & !reg_error;

  assign loc_alert_regwen_2_wd = reg_wdata[0];
  assign loc_alert_regwen_3_we = addr_hit[13] & reg_we & !reg_error;

  assign loc_alert_regwen_3_wd = reg_wdata[0];
  assign loc_alert_regwen_4_we = addr_hit[14] & reg_we & !reg_error;

  assign loc_alert_regwen_4_wd = reg_wdata[0];
  assign loc_alert_regwen_5_we = addr_hit[15] & reg_we & !reg_error;

  assign loc_alert_regwen_5_wd = reg_wdata[0];
  assign loc_alert_regwen_6_we = addr_hit[16] & reg_we & !reg_error;

  assign loc_alert_regwen_6_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_0_re = addr_hit[17] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_0_we = addr_hit[17] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_0_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_1_re = addr_hit[18] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_1_we = addr_hit[18] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_1_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_2_re = addr_hit[19] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_2_we = addr_hit[19] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_2_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_3_re = addr_hit[20] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_3_we = addr_hit[20] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_3_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_4_re = addr_hit[21] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_4_we = addr_hit[21] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_4_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_5_re = addr_hit[22] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_5_we = addr_hit[22] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_5_wd = reg_wdata[0];
  assign loc_alert_en_shadowed_6_re = addr_hit[23] & reg_re & !reg_error;
  assign loc_alert_en_shadowed_6_we = addr_hit[23] & reg_we & !reg_error;

  assign loc_alert_en_shadowed_6_wd = reg_wdata[0];
  assign loc_alert_class_shadowed_0_re = addr_hit[24] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_0_we = addr_hit[24] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_0_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_1_re = addr_hit[25] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_1_we = addr_hit[25] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_1_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_2_re = addr_hit[26] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_2_we = addr_hit[26] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_2_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_3_re = addr_hit[27] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_3_we = addr_hit[27] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_3_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_4_re = addr_hit[28] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_4_we = addr_hit[28] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_4_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_5_re = addr_hit[29] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_5_we = addr_hit[29] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_5_wd = reg_wdata[1:0];
  assign loc_alert_class_shadowed_6_re = addr_hit[30] & reg_re & !reg_error;
  assign loc_alert_class_shadowed_6_we = addr_hit[30] & reg_we & !reg_error;

  assign loc_alert_class_shadowed_6_wd = reg_wdata[1:0];
  assign loc_alert_cause_0_we = addr_hit[31] & reg_we & !reg_error;

  assign loc_alert_cause_0_wd = reg_wdata[0];
  assign loc_alert_cause_1_we = addr_hit[32] & reg_we & !reg_error;

  assign loc_alert_cause_1_wd = reg_wdata[0];
  assign loc_alert_cause_2_we = addr_hit[33] & reg_we & !reg_error;

  assign loc_alert_cause_2_wd = reg_wdata[0];
  assign loc_alert_cause_3_we = addr_hit[34] & reg_we & !reg_error;

  assign loc_alert_cause_3_wd = reg_wdata[0];
  assign loc_alert_cause_4_we = addr_hit[35] & reg_we & !reg_error;

  assign loc_alert_cause_4_wd = reg_wdata[0];
  assign loc_alert_cause_5_we = addr_hit[36] & reg_we & !reg_error;

  assign loc_alert_cause_5_wd = reg_wdata[0];
  assign loc_alert_cause_6_we = addr_hit[37] & reg_we & !reg_error;
  ...
  assign classa_ctrl_shadowed_re = addr_hit[39] & reg_re & !reg_error;
  assign classa_ctrl_shadowed_we = addr_hit[39] & reg_we & !reg_error;
  ...
  assign classa_clr_shadowed_re = addr_hit[41] & reg_re & !reg_error;
  assign classa_clr_shadowed_we = addr_hit[41] & reg_we & !reg_error;

  assign classa_clr_shadowed_wd = reg_wdata[0];
  assign classa_accum_cnt_re = addr_hit[42] & reg_re & !reg_error;
  assign classa_accum_thresh_shadowed_re = addr_hit[43] & reg_re & !reg_error;
  assign classa_accum_thresh_shadowed_we = addr_hit[43] & reg_we & !reg_error;

  assign classa_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classa_timeout_cyc_shadowed_re = addr_hit[44] & reg_re & !reg_error;
  assign classa_timeout_cyc_shadowed_we = addr_hit[44] & reg_we & !reg_error;

  assign classa_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_crashdump_trigger_shadowed_re = addr_hit[45] & reg_re & !reg_error;
  assign classa_crashdump_trigger_shadowed_we = addr_hit[45] & reg_we & !reg_error;

  assign classa_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classa_phase0_cyc_shadowed_re = addr_hit[46] & reg_re & !reg_error;
  assign classa_phase0_cyc_shadowed_we = addr_hit[46] & reg_we & !reg_error;

  assign classa_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase1_cyc_shadowed_re = addr_hit[47] & reg_re & !reg_error;
  assign classa_phase1_cyc_shadowed_we = addr_hit[47] & reg_we & !reg_error;

  assign classa_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase2_cyc_shadowed_re = addr_hit[48] & reg_re & !reg_error;
  assign classa_phase2_cyc_shadowed_we = addr_hit[48] & reg_we & !reg_error;

  assign classa_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase3_cyc_shadowed_re = addr_hit[49] & reg_re & !reg_error;
  assign classa_phase3_cyc_shadowed_we = addr_hit[49] & reg_we & !reg_error;

  assign classa_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_esc_cnt_re = addr_hit[50] & reg_re & !reg_error;
  assign classa_state_re = addr_hit[51] & reg_re & !reg_error;
  assign classb_regwen_we = addr_hit[52] & reg_we & !reg_error;

  assign classb_regwen_wd = reg_wdata[0];
  assign classb_ctrl_shadowed_re = addr_hit[53] & reg_re & !reg_error;
  assign classb_ctrl_shadowed_we = addr_hit[53] & reg_we & !reg_error;
  ...
  assign classb_clr_regwen_we = addr_hit[54] & reg_we & !reg_error;

  assign classb_clr_regwen_wd = reg_wdata[0];
  assign classb_clr_shadowed_re = addr_hit[55] & reg_re & !reg_error;
  assign classb_clr_shadowed_we = addr_hit[55] & reg_we & !reg_error;

  assign classb_clr_shadowed_wd = reg_wdata[0];
  assign classb_accum_cnt_re = addr_hit[56] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_re = addr_hit[57] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_we = addr_hit[57] & reg_we & !reg_error;

  assign classb_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classb_timeout_cyc_shadowed_re = addr_hit[58] & reg_re & !reg_error;
  assign classb_timeout_cyc_shadowed_we = addr_hit[58] & reg_we & !reg_error;

  assign classb_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_crashdump_trigger_shadowed_re = addr_hit[59] & reg_re & !reg_error;
  assign classb_crashdump_trigger_shadowed_we = addr_hit[59] & reg_we & !reg_error;

  assign classb_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classb_phase0_cyc_shadowed_re = addr_hit[60] & reg_re & !reg_error;
  assign classb_phase0_cyc_shadowed_we = addr_hit[60] & reg_we & !reg_error;

  assign classb_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase1_cyc_shadowed_re = addr_hit[61] & reg_re & !reg_error;
  assign classb_phase1_cyc_shadowed_we = addr_hit[61] & reg_we & !reg_error;

  assign classb_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase2_cyc_shadowed_re = addr_hit[62] & reg_re & !reg_error;
  assign classb_phase2_cyc_shadowed_we = addr_hit[62] & reg_we & !reg_error;

  assign classb_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase3_cyc_shadowed_re = addr_hit[63] & reg_re & !reg_error;
  assign classb_phase3_cyc_shadowed_we = addr_hit[63] & reg_we & !reg_error;

  assign classb_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_esc_cnt_re = addr_hit[64] & reg_re & !reg_error;
  assign classb_state_re = addr_hit[65] & reg_re & !reg_error;
  assign classc_regwen_we = addr_hit[66] & reg_we & !reg_error;

  assign classc_regwen_wd = reg_wdata[0];
  assign classc_ctrl_shadowed_re = addr_hit[67] & reg_re & !reg_error;
  assign classc_ctrl_shadowed_we = addr_hit[67] & reg_we & !reg_error;
  ...
  assign classc_clr_regwen_we = addr_hit[68] & reg_we & !reg_error;

  assign classc_clr_regwen_wd = reg_wdata[0];
  assign classc_clr_shadowed_re = addr_hit[69] & reg_re & !reg_error;
  assign classc_clr_shadowed_we = addr_hit[69] & reg_we & !reg_error;

  assign classc_clr_shadowed_wd = reg_wdata[0];
  assign classc_accum_cnt_re = addr_hit[70] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_re = addr_hit[71] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_we = addr_hit[71] & reg_we & !reg_error;

  assign classc_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classc_timeout_cyc_shadowed_re = addr_hit[72] & reg_re & !reg_error;
  assign classc_timeout_cyc_shadowed_we = addr_hit[72] & reg_we & !reg_error;

  assign classc_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_crashdump_trigger_shadowed_re = addr_hit[73] & reg_re & !reg_error;
  assign classc_crashdump_trigger_shadowed_we = addr_hit[73] & reg_we & !reg_error;

  assign classc_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classc_phase0_cyc_shadowed_re = addr_hit[74] & reg_re & !reg_error;
  assign classc_phase0_cyc_shadowed_we = addr_hit[74] & reg_we & !reg_error;

  assign classc_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase1_cyc_shadowed_re = addr_hit[75] & reg_re & !reg_error;
  assign classc_phase1_cyc_shadowed_we = addr_hit[75] & reg_we & !reg_error;

  assign classc_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase2_cyc_shadowed_re = addr_hit[76] & reg_re & !reg_error;
  assign classc_phase2_cyc_shadowed_we = addr_hit[76] & reg_we & !reg_error;

  assign classc_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase3_cyc_shadowed_re = addr_hit[77] & reg_re & !reg_error;
  assign classc_phase3_cyc_shadowed_we = addr_hit[77] & reg_we & !reg_error;

  assign classc_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_esc_cnt_re = addr_hit[78] & reg_re & !reg_error;
  assign classc_state_re = addr_hit[79] & reg_re & !reg_error;
  assign classd_regwen_we = addr_hit[80] & reg_we & !reg_error;

  assign classd_regwen_wd = reg_wdata[0];
  assign classd_ctrl_shadowed_re = addr_hit[81] & reg_re & !reg_error;
  assign classd_ctrl_shadowed_we = addr_hit[81] & reg_we & !reg_error;
  ...
  assign classd_clr_regwen_we = addr_hit[82] & reg_we & !reg_error;

  assign classd_clr_regwen_wd = reg_wdata[0];
  assign classd_clr_shadowed_re = addr_hit[83] & reg_re & !reg_error;
  assign classd_clr_shadowed_we = addr_hit[83] & reg_we & !reg_error;

  assign classd_clr_shadowed_wd = reg_wdata[0];
  assign classd_accum_cnt_re = addr_hit[84] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_re = addr_hit[85] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_we = addr_hit[85] & reg_we & !reg_error;

  assign classd_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classd_timeout_cyc_shadowed_re = addr_hit[86] & reg_re & !reg_error;
  assign classd_timeout_cyc_shadowed_we = addr_hit[86] & reg_we & !reg_error;

  assign classd_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classd_crashdump_trigger_shadowed_re = addr_hit[87] & reg_re & !reg_error;
  assign classd_crashdump_trigger_shadowed_we = addr_hit[87] & reg_we & !reg_error;

  assign classd_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classd_phase0_cyc_shadowed_re = addr_hit[88] & reg_re & !reg_error;
  assign classd_phase0_cyc_shadowed_we = addr_hit[88] & reg_we & !reg_error;

  assign classd_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classd_phase1_cyc_shadowed_re = addr_hit[89] & reg_re & !reg_error;
  assign classd_phase1_cyc_shadowed_we = addr_hit[89] & reg_we & !reg_error;

  assign classd_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classd_phase2_cyc_shadowed_re = addr_hit[90] & reg_re & !reg_error;
  assign classd_phase2_cyc_shadowed_we = addr_hit[90] & reg_we & !reg_error;

  assign classd_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classd_phase3_cyc_shadowed_re = addr_hit[91] & reg_re & !reg_error;
  assign classd_phase3_cyc_shadowed_we = addr_hit[91] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[6] = alert_regwen_we;
    reg_we_check[7] = alert_en_shadowed_gated_we;
    reg_we_check[8] = alert_class_shadowed_gated_we;
    reg_we_check[9] = alert_cause_we;
    reg_we_check[10] = loc_alert_regwen_0_we;
    reg_we_check[11] = loc_alert_regwen_1_we;
    reg_we_check[12] = loc_alert_regwen_2_we;
    reg_we_check[13] = loc_alert_regwen_3_we;
    reg_we_check[14] = loc_alert_regwen_4_we;
    reg_we_check[15] = loc_alert_regwen_5_we;
    reg_we_check[16] = loc_alert_regwen_6_we;
    reg_we_check[17] = loc_alert_en_shadowed_0_gated_we;
    reg_we_check[18] = loc_alert_en_shadowed_1_gated_we;
    reg_we_check[19] = loc_alert_en_shadowed_2_gated_we;
    reg_we_check[20] = loc_alert_en_shadowed_3_gated_we;
    reg_we_check[21] = loc_alert_en_shadowed_4_gated_we;
    reg_we_check[22] = loc_alert_en_shadowed_5_gated_we;
    reg_we_check[23] = loc_alert_en_shadowed_6_gated_we;
    reg_we_check[24] = loc_alert_class_shadowed_0_gated_we;
    reg_we_check[25] = loc_alert_class_shadowed_1_gated_we;
    reg_we_check[26] = loc_alert_class_shadowed_2_gated_we;
    reg_we_check[27] = loc_alert_class_shadowed_3_gated_we;
    reg_we_check[28] = loc_alert_class_shadowed_4_gated_we;
    reg_we_check[29] = loc_alert_class_shadowed_5_gated_we;
    reg_we_check[30] = loc_alert_class_shadowed_6_gated_we;
    reg_we_check[31] = loc_alert_cause_0_we;
    reg_we_check[32] = loc_alert_cause_1_we;
    reg_we_check[33] = loc_alert_cause_2_we;
    reg_we_check[34] = loc_alert_cause_3_we;
    reg_we_check[35] = loc_alert_cause_4_we;
    reg_we_check[36] = loc_alert_cause_5_we;
    reg_we_check[37] = loc_alert_cause_6_we;
    reg_we_check[38] = classa_regwen_we;
    reg_we_check[39] = classa_ctrl_shadowed_gated_we;
    reg_we_check[40] = classa_clr_regwen_we;
    reg_we_check[41] = classa_clr_shadowed_gated_we;
    reg_we_check[42] = 1'b0;
    reg_we_check[43] = classa_accum_thresh_shadowed_gated_we;
    reg_we_check[44] = classa_timeout_cyc_shadowed_gated_we;
    reg_we_check[45] = classa_crashdump_trigger_shadowed_gated_we;
    reg_we_check[46] = classa_phase0_cyc_shadowed_gated_we;
    reg_we_check[47] = classa_phase1_cyc_shadowed_gated_we;
    reg_we_check[48] = classa_phase2_cyc_shadowed_gated_we;
    reg_we_check[49] = classa_phase3_cyc_shadowed_gated_we;
    reg_we_check[50] = 1'b0;
    reg_we_check[51] = 1'b0;
    reg_we_check[52] = classb_regwen_we;
    reg_we_check[53] = classb_ctrl_shadowed_gated_we;
    reg_we_check[54] = classb_clr_regwen_we;
    reg_we_check[55] = classb_clr_shadowed_gated_we;
    reg_we_check[56] = 1'b0;
    reg_we_check[57] = classb_accum_thresh_shadowed_gated_we;
    reg_we_check[58] = classb_timeout_cyc_shadowed_gated_we;
    reg_we_check[59] = classb_crashdump_trigger_shadowed_gated_we;
    reg_we_check[60] = classb_phase0_cyc_shadowed_gated_we;
    reg_we_check[61] = classb_phase1_cyc_shadowed_gated_we;
    reg_we_check[62] = classb_phase2_cyc_shadowed_gated_we;
    reg_we_check[63] = classb_phase3_cyc_shadowed_gated_we;
    reg_we_check[64] = 1'b0;
    reg_we_check[65] = 1'b0;
    reg_we_check[66] = classc_regwen_we;
    reg_we_check[67] = classc_ctrl_shadowed_gated_we;
    reg_we_check[68] = classc_clr_regwen_we;
    reg_we_check[69] = classc_clr_shadowed_gated_we;
    reg_we_check[70] = 1'b0;
    reg_we_check[71] = classc_accum_thresh_shadowed_gated_we;
    reg_we_check[72] = classc_timeout_cyc_shadowed_gated_we;
    reg_we_check[73] = classc_crashdump_trigger_shadowed_gated_we;
    reg_we_check[74] = classc_phase0_cyc_shadowed_gated_we;
    reg_we_check[75] = classc_phase1_cyc_shadowed_gated_we;
    reg_we_check[76] = classc_phase2_cyc_shadowed_gated_we;
    reg_we_check[77] = classc_phase3_cyc_shadowed_gated_we;
    reg_we_check[78] = 1'b0;
    reg_we_check[79] = 1'b0;
    reg_we_check[80] = classd_regwen_we;
    reg_we_check[81] = classd_ctrl_shadowed_gated_we;
    reg_we_check[82] = classd_clr_regwen_we;
    reg_we_check[83] = classd_clr_shadowed_gated_we;
    reg_we_check[84] = 1'b0;
    reg_we_check[85] = classd_accum_thresh_shadowed_gated_we;
    reg_we_check[86] = classd_timeout_cyc_shadowed_gated_we;
    reg_we_check[87] = classd_crashdump_trigger_shadowed_gated_we;
    reg_we_check[88] = classd_phase0_cyc_shadowed_gated_we;
    reg_we_check[89] = classd_phase1_cyc_shadowed_gated_we;
    reg_we_check[90] = classd_phase2_cyc_shadowed_gated_we;
    reg_we_check[91] = classd_phase3_cyc_shadowed_gated_we;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[7]: begin
        reg_rdata_next[0] = alert_en_shadowed_qs;
      end

      addr_hit[8]: begin
        reg_rdata_next[1:0] = alert_class_shadowed_qs;
      end
  ...
  assign shadowed_storage_err_o = |{
    ...
    alert_en_shadowed_storage_err,
    alert_class_shadowed_storage_err,
  ...
  assign shadowed_update_err_o = |{
    ...
    alert_en_shadowed_update_err,
    alert_class_shadowed_update_err,
