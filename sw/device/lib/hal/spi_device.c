...
void spi_device_init(spi_device_t spi_device)
{
    ...
    spi_device_cmd_info_set(spi_device, command_slot_0, 0);
    ...
    spi_device_cmd_info_set(spi_device, command_slot_3, 3);
    ...
    spi_device_cmd_info_set(spi_device, command_slot_4, 4);
    ...
    spi_device_cmd_info_set(spi_device, command_slot_5, 5);
    ...
    spi_device_cmd_info_set(spi_device, command_slot_11, 11);
    ...
    spi_device_cmd_info_set(spi_device, command_slot_12, 12);
    ...
    spi_device_cmd_info_set(spi_device, command_info_13, 13);
    ...
    spi_device_cmd_info_set(spi_device, command_info_14, 14);
...
{
    for (size_t index = 0; index < array_len(spi_device->cmd_filter); index++) {
...
bool spi_device_software_command_get(spi_device_t spi_device, spi_device_software_command *command)
{
